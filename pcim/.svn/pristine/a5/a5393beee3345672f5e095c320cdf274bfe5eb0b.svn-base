...
void LoginManager::SetProfileId(const std::string &profileid)
{
...
std::string LoginManager::GetProfileId()
{
	return profileid_;
}

std::string LoginManager::GetSupplierId(){
	return supplierid_;
}

void LoginManager::SetSupplierId(const std::string &supplierid)
{
	supplierid_ = supplierid;
}

Rest::Profile LoginManager::GetProfileInfo(){
	return profile_info_;
}

void LoginManager::SetProfileInfo(const Rest::Profile info){
	profile_info_ = info;
}
