...
nim_comp::CMenuWnd* RichEditWithDefMenu::CreateMenuWnd(const POINT& mouse_pos)
{
	...
	nim_comp::CMenuWnd* pMenu = new nim_comp::CMenuWnd();
	...
	if (menu_list != nullptr)
	{
		...
		{
			auto menu_element = dynamic_cast<nim_comp::CMenuElementUI*>(menu_list->GetItemAt(index));
