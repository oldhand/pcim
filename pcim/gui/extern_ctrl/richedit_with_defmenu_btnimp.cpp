...
void MenuBtnHandel::Reset(nim_comp::CMenuElementUI* menu_element, unsigned sel_start, unsigned sel_end)
{
...
void MenuBtnHandel_Copy::DoReset(nim_comp::CMenuElementUI* menu_element)
{
...
void MenuBtnHandel_Cut::DoReset(nim_comp::CMenuElementUI* menu_element)
{
	if (sel_end_ <= sel_start_)
		menu_element->SetEnabled(false);
	menu_element->AttachSelect(ToWeakCallback([this](ui::EventArgs*){
...
void MenuBtnHandel_Paste::DoReset(nim_comp::CMenuElementUI* menu_element)
{
