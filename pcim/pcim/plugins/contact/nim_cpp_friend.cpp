...
void Friend::GetList(const GetFriendsListCallback& cb, const std::string& json_extension)
{
	...
	if (cb)
	{
		...
		CallbackProxy::DoSafeCallback<Friend::GetFriendsListCallback>(get_friends_list_cb, [=](const Friend::GetFriendsListCallback& list_cb){
			//const char *result_json = "{\n\"list\" : [\n{\n\"accid\" : \"p_43877520964585885\",\n\"alias\" : \"\",\n\"beflag\" : 1,\n\"bits\" : 0,\n\"create_timetag\" : 1539358702979,\n\"ex\" : \"\",\n\"flag\" : 1,\n\"source\" : 0,\n\"update_timetag\" : 1539358702979\n}\n]\n}";
			//std::list<FriendProfile> friends_profile;
			//ParseFriendsProfile(PCharToString(result_json), friends_profile);

			std::string profileid = nim_comp::LoginManager::GetInstance()->GetProfileId();
			std::list<Db::Contact> contacts = Api::ContactApi::getContactsFromDb(profileid);
			CallbackProxy::Invoke(list_cb, (NIMResCode)200, contacts);
		}, true);
	}
	...
	const char *result_json = "{\n\"list\" : [\n{\n\"accid\" : \"p_43877520964585885\",\n\"alias\" : \"\",\n\"beflag\" : 1,\n\"bits\" : 0,\n\"create_timetag\" : 1539358702979,\n\"ex\" : \"\",\n\"flag\" : 1,\n\"source\" : 0,\n\"update_timetag\" : 1539358702979\n}\n]\n}";
	ParseFriendsProfile(PCharToString(result_json), friends_profile);
	CallbackProxy::Invoke(cb, PCharToString("200"), friends_profile);*/
