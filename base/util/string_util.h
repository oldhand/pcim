...
namespace nbase
{
BASE_EXPORT std::list<std::string> listIntToString(std::list<int>);
BASE_EXPORT std::string join(std::list<std::string> lists, std::string delimitor);
BASE_EXPORT std::string join(std::list<int> lists, std::string delimitor);
// format a string
